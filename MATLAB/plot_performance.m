...
ax=axes(h);
hold(ax,"on");
[~, ~, history, stop_iter] = quadprog_to_lsqr_wrapper(a, b, @pgd_quadprognonneg);
plot(ax,0:stop_iter, cell2mat(history.feval),"DisplayName","Least Squares Projected Gradient Descent");
[~, ~, history, stop_iter] = quadprog_to_lsqr_wrapper(a, b, @multipupd_quadprognonneg);
...
plot(ax2,0:stop_iter, abs(cell2mat(history.feval)),"DisplayName","Bisection");
ax2.YScale = "log";
